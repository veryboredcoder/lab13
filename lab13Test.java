...
public class lab13Test 
{
	...
	public void setUp() throws Exception 
	{
		...
		try
		{
			...
			for(int i = 0; i < expectedResult1.length; i ++){ expectedResult1[i] = testData.get(0).get(i);}
			assertArrayEquals("expectedResult1 is not equal to lab.getResult1()", expectedResult1, lab.getResult1());
			...
			for(int i = 0; i < expectedResult2.length; i ++){ expectedResult2[i] = testData.get(1).get(i);}
			assertArrayEquals("expectedResult2 is not equal to lab.getResult2()", expectedResult2, lab.getResult2());
			...
			for(int i = 0; i < expectedResult3.length; i ++){ expectedResult3[i] = testData.get(2).get(i);}
			assertArrayEquals("expectedResult3 is not equal to lab.getResult3()", expectedResult3, lab.getResult3());
